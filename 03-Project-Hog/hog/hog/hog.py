...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    strnum = str(score*score*score)
    result = 0
    for i in range(len(strnum)):
        result += int(strnum[i])*((-1)**i)
    return 1 + abs(result)
...
def is_swap(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    temp = 3 ** (player_score + opponent_score)
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            if feral_hogs and abs(num_rolls - pre0) == 2:
                score0 += 3
            pre0 = take_turn(num_rolls, score1, dice)
            score0 += pre0
        else:
            num_rolls = strategy1(score1,score0)
            if feral_hogs and abs(num_rolls - pre1) == 2:
                score1 += 3
            pre1 = take_turn(num_rolls, score0, dice)
            score1 += pre1
